...
export class DashboardComponent {
	...
	setTasks() {
		this.tasks = this.db.filter(task => {
			if (!this.filterPriority.length) return task
			return this.filterPriority.includes(task.priority)
		})
	}
	...
	setFilterTag(node:any) {
		...
		console.log(this.filterTag, node.value)
		this.setTasks()
	}
}
